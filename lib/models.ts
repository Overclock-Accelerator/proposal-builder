...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    description: 'Fast multimodal model with 204K context and 131K output',
    category: 'fast',
  },
  {
    id: 'z-ai/glm-5-turbo',
    ...
    outputPricePer1K: 0.004,
    description: 'High-capability Zhipu model with strong reasoning',
    category: 'performant',
  },
  {
    ...
    inputPricePer1K: 0.00042,
    outputPricePer1K: 0.0022,
    description: 'Moonshot model with 262K context — balanced speed and quality',
    category: 'both',
  },
  {
    ...
    description: 'xAI ultra-fast model with massive 2M token context window',
    category: 'fast',
  },
]
